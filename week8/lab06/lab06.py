class Transaction:
    ...
    def report(self):
        ...
        if self.changed():
            "*** YOUR CODE HERE ***"
            flag = 'increased' if self.before < self.after else 'decreased'
            msg =  f'{flag} {str(self.before)}->{str(self.after)}'
...
class Account:
    ...
    def deposit(self, amount):
        ...
        print('DEBUG',self.balance-amount,self.balance)
        return self.balance
