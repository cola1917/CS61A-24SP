...
class VendingMachine:
    ...
    def vend(self):
        ...
        elif self.received < self.price:
            return f'Please add ${self.price-self.received} more funds.'
        else:
             change = self.received - self.price
             self.received = 0
             self.count -= 1
    ...
    def add_funds(self, money):
        ...
        self.received += money
        return f'Current balance: ${self.received}'
    def restock(self, amount):
        self.count += amount
        return f'Current {self.goods} stock: {self.count}'
# def first_digit(n):
#     if n >= 10:
...
def store_digits(n):
    ...
    """
    "*** YOUR CODE HERE ***"
    # 我很难理解 先生成最内部得链表，再把内部链表当作元素传给外部链表
    result = Link.empty
    while n > 0:
