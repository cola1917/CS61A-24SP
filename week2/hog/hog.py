...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    result = [dice() for num in range(num_rolls)]
    if result.count(1):
        return 1
    else:
        return sum(result)
...
def always_roll(n):
    ...
    # BEGIN PROBLEM 6
    "*** YOUR CODE HERE ***"
    def inside_func(player_score, opponent_score):
        return n
    return inside_func
    # END PROBLEM 6
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    poss = [strategy(score0, score1) for score1 in range(goal) for score0 in range(goal)]
    # print('DEBUG', poss)
    return len(set(poss)) == 1
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    average_gen = make_averaged(roll_dice,samples_count)
    averages = [average_gen(time, dice)for time in range(1,11)]
    # print('DEBUG', averages)
